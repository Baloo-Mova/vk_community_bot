                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <div class="single-feature" data-aos="fade-left" data-aos-delay="400">
                                ...
                                <div class="features-details">
                                    <h5>Цепочки писем</h5>
                                    <p> Взаимодействуйте с пользователем в течение длительного времени, отсылая ему новый контент через определенное время после подписки – можно промежуток с точностью до минуты. </p>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                        </li>
                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="panel">
                        ...
                        <div id="collapse_2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_2">
                            <div class="panel-body">
                                Нет, Вы можете писать только людям, которые давали на это согласия с помощью нажатия кнопки подписки на уведомления или тем, кто хоть раз писал в сообщения Вашей группы. В окне диалоге человек также может отписаться от сообщений
                            </div>
                        </div>
                    </div>
                    <!---->
