    ...
    <div class="container-fluid">
        ...
        <div id="modal_add" class="modal">
            <div class="modal-content">
                <h4>Добавление</h4>
                <form action="{{ route('group.task.times.add') }}" method="post">
                    {{ csrf_field() }}
                    {{--<input type="hidden" name="group_id" value="{{$real_group_id}}">--}}
                    <input type="hidden" name="bot_community_response_id" value="{{ $group_task_id }}">
                    <div class="row">
        ...
        <div id="modal_edit" class="modal">
            <div class="modal-content">
                ...
                <form action="{{ route('group.task.times.edit') }}" method="post">
                    {{ csrf_field() }}
                    <input type="hidden" name="bot_community_response_id" value="{{ $group_task_id }}">
                        ...
                        @forelse($times as $time)
                            <tr>
                                ...
                                <td class="col s4 table_td">
                                    ...
                                    <a href="{{ route('group.task.times.delete', ['id' => $time->id]) }}"
